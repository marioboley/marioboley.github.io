...
slidesurl: 
citation: 'Yang, Fan, Pierre Le Bodic, and Mario Boley. "Gradient Boosting Versus Mixed Integer Programming for Sparse Additive Modeling." <i>Joint European Conference on Machine Learning and Knowledge Discovery in Databases</i> (ECMLPKDD 2025): 453-470.'
bibtex: |-
    @inproceedings{yang2025gbversusmip,
        title={Gradient Boosting Versus Mixed Integer Programming for Sparse Additive Modeling},
